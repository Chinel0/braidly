  ...
  try {
    await resend.emails.send({
      ...
      html: `<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:40px 20px;color:#2C1A0E;">
        ...
        <a href="https://braidely.vercel.app/#braiders" style="display:inline-block;margin-top:24px;background:#3D5212;color:white;padding:14px 28px;text-decoration:none;font-weight:bold;">View Your Profile</a>
